...
func (*stubStore) ReleaseLeaseOwned(context.Context, string, string, string) error  { return nil }
...
func (*stubStore) AppendScenarioAcceptance(context.Context, string, []string) error { return nil }
