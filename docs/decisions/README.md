...
| [0024](0024-remote-executor-agent-per-host.md) | Remote-executor (çok-host) | **Agent-per-host** (kullanıcı kararı): daemon her host'ta; merkezi-PG'den capability-uyan lease; iş yerelde; ssh/uzak-komut YOK; host-üstü lease zaten N-4'te | 🔄 Uygulanıyor (Dalga B) |
