...
- **N-10 (Governance-policy):** 🔄 Agent. ADR-0003. internal/governance — tier→merge-mode (T1/T2 auto, T3/T4 human-required); verify-pass sonrası conductor'da policy danış: human gerekiyorsa MERGE YOK + intervention-needed (N-9'a bağlı). nil/default=auto-all (e2e bozulmaz). Deterministik testler.
